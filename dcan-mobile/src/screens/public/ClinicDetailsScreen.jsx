      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.actionRow}>
            <Button mode="outlined" onPress={openMap} style={{ flex: 1 }}>
              Mapa
            </Button>
            <Button mode="contained" onPress={makeCall} style={{ flex: 1, backgroundColor: "#2E8B57" }}>
              Llamar
            </Button>
          </View>
          ...
          <Button
            ...
            onPress={() => {
              if (!user) {
                // ✅ Público: NO intentamos ir a ClientDashboard (no existe en stack público)
                navigation.navigate("Login", { selectedClinic: clinic });
              } else {
                // ✅ Privado: aquí sí existe ClientDashboard
